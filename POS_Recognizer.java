...
public class POS_Recognizer {
     ...
     */
    public PS5(String trainS, String trainT) {
     ...
     */
    public static void trainModel(PS5 model) throws IOException {
     ...
     * @throws IOException for invalid file on BufferedReader
     */
    public static void testModel(PS5 model, String testSentences, String testTags) throws IOException{
     ...
     */
    public static List<String> viterbi(PS5 model, String sLine) {
        sLine.toLowerCase();
     ...
     * @param model the trained model
     */
    public static void userTest(PS5 model) {
     ...
     */
    public static void simpleTest(PS5 model) {
     ...
     * @return
     */
    public static boolean simpleTestHelp(PS5 model, String sentence, ArrayList<String> expected){
        int x=0;
    ...
    /**
     * Main method to execute PS5 exercises including tests
     */
    public static void main(String[] args) {
        //Test with hardcoded graph based on PD-7
        PS5 testModel = new PS5("","");
        simpleTest(testModel);

        //Train and test on simple text sets
        System.out.println("Simple:");
        PS5 modelS = new PS5("inputs/simple-train-sentences.txt","inputs/simple-train-tags.txt");
        try {
            trainModel(modelS);
        ...
        PS5 modelB = new PS5("inputs/brown-train-sentences.txt","inputs/brown-train-tags.txt");
        try {
            trainModel(modelB);
